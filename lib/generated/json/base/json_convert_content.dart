...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case SystemListEntity:
			...
			return systemListDataDataFromJson(data as SystemListDataData, json) as T;			case BannerEntityEntity:
			...
			return systemDataDatachildFromJson(data as SystemDataDatachild, json) as T;			case ProjectTopTitleEntity:
			return projectTopTitleEntityFromJson(data as ProjectTopTitleEntity, json) as T;			case ProjectTopTitleData:
			return projectTopTitleDataFromJson(data as ProjectTopTitleData, json) as T;			case HomeArticleEntityEntity:
			...
			return homeArticleEntityDataDataFromJson(data as HomeArticleEntityDataData, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case SystemListEntity:
			...
			return systemListDataDataToJson(data as SystemListDataData);			case BannerEntityEntity:
			...
			return systemDataDatachildToJson(data as SystemDataDatachild);			case ProjectTopTitleEntity:
			return projectTopTitleEntityToJson(data as ProjectTopTitleEntity);			case ProjectTopTitleData:
			return projectTopTitleDataToJson(data as ProjectTopTitleData);			case HomeArticleEntityEntity:
			...
			return homeArticleEntityDataDataToJson(data as HomeArticleEntityDataData);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'SystemListEntity':
			...
			return SystemListDataData().fromJson(json);			case 'BannerEntityEntity':
			...
			return SystemDataDatachild().fromJson(json);			case 'ProjectTopTitleEntity':
			return ProjectTopTitleEntity().fromJson(json);			case 'ProjectTopTitleData':
			return ProjectTopTitleData().fromJson(json);			case 'HomeArticleEntityEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'SystemListEntity':
			...
			return List<SystemListDataData>();			case 'BannerEntityEntity':
			...
			return List<SystemDataDatachild>();			case 'ProjectTopTitleEntity':
			return List<ProjectTopTitleEntity>();			case 'ProjectTopTitleData':
			return List<ProjectTopTitleData>();			case 'HomeArticleEntityEntity':
