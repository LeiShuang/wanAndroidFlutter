...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case HomeArticleEntityEntity:
			...
			return homeArticleEntityDataDataFromJson(data as HomeArticleEntityDataData, json) as T;			case BannerEntityEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case HomeArticleEntityEntity:
			...
			return homeArticleEntityDataDataToJson(data as HomeArticleEntityDataData);			case BannerEntityEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'HomeArticleEntityEntity':
			...
			return HomeArticleEntityDataData().fromJson(json);			case 'BannerEntityEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'HomeArticleEntityEntity':
			...
			return List<HomeArticleEntityDataData>();			case 'BannerEntityEntity':
