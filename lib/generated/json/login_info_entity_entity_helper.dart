...
loginInfoEntityEntityFromJson(LoginInfoEntityEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new LoginInfoEntityData().fromJson(json['data']);
	}
...
Map<String, dynamic> loginInfoEntityEntityToJson(LoginInfoEntityEntity entity) {
...
loginInfoEntityDataFromJson(LoginInfoEntityData data, Map<String, dynamic> json) {
	if (json['admin'] != null) {
...
Map<String, dynamic> loginInfoEntityDataToJson(LoginInfoEntityData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
