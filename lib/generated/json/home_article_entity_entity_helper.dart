...
homeArticleEntityEntityFromJson(HomeArticleEntityEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new HomeArticleEntityData().fromJson(json['data']);
	}
...
Map<String, dynamic> homeArticleEntityEntityToJson(HomeArticleEntityEntity entity) {
...
homeArticleEntityDataFromJson(HomeArticleEntityData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<HomeArticleEntityDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new HomeArticleEntityDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> homeArticleEntityDataToJson(HomeArticleEntityData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
homeArticleEntityDataDataFromJson(HomeArticleEntityDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeArticleEntityDataDataToJson(HomeArticleEntityDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
