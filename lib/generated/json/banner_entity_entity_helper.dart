...
bannerEntityEntityFromJson(BannerEntityEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<BannerEntityData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new BannerEntityData().fromJson(v));
		});
	}
...
Map<String, dynamic> bannerEntityEntityToJson(BannerEntityEntity entity) {
