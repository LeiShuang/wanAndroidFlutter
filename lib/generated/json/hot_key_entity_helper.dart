...
hotKeyEntityFromJson(HotKeyEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<HotKeyEntityData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new HotKeyEntityData().fromJson(v));
		});
	}
...
hotKeyEntityDataFromJson(HotKeyEntityData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> hotKeyEntityDataToJson(HotKeyEntityData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
